...
namespace SWRevealViewControllerBinding
{
    ...
    interface SWRevealViewControllerDelegate
    {
        ...
        void RevealControllerWillMoveToPosition(SWRevealViewController revealController, FrontViewPosition position);
        ...
        void RevealControllerDidMoveToPosition(SWRevealViewController revealController, FrontViewPosition position);
        ...
        void RevealControllerAnimateToPosition(SWRevealViewController revealController, FrontViewPosition position);
        ...
        bool RevealControllerPanGestureRecognizerShouldRecognizeSimultaneouslyWithGestureRecognizer(SWRevealViewController revealController, UIGestureRecognizer otherGestureRecognizer);
        ...
        bool RevealControllerTapGestureRecognizerShouldRecognizeSimultaneouslyWithGestureRecognizer(SWRevealViewController revealController, UIGestureRecognizer otherGestureRecognizer);
        ...
        void RevealControllerPanGestureBeganFromLocation(SWRevealViewController revealController, nfloat location, nfloat progress, nfloat overProgress);
        ...
        void RevealControllerPanGestureMovedToLocation(SWRevealViewController revealController, nfloat location, nfloat progress, nfloat overProgress);
        ...
        void RevealControllerPanGestureEndedToLocation(SWRevealViewController revealController, nfloat location, nfloat progress, nfloat overProgress);
        ...
        void RevealControllerWillAddViewController(SWRevealViewController revealController, UIViewController viewController, SWRevealControllerOperation operation, bool animated);
        ...
        void RevealControllerDidAddViewController(SWRevealViewController revealController, UIViewController viewController, SWRevealControllerOperation operation, bool animated);
        ...
        UIViewControllerAnimatedTransitioning RevealController(SWRevealViewController revealController, SWRevealControllerOperation operation, UIViewController fromVC, UIViewController toVC);
        ...
        void RevealControllerPanGestureBeganFromLocation(SWRevealViewController revealController, nfloat location, nfloat progress);
        ...
        void RevealControllerPanGestureMovedToLocation(SWRevealViewController revealController, nfloat location, nfloat progress);
        ...
        void RevealControllerPanGestureEndedToLocation(SWRevealViewController revealController, nfloat location, nfloat progress);
    }
